...
def plot_resize(img, scale, nnscale, bscale, ed_img, ed_nnscale, ed_bscale, mr_img, wmr_img, mdr_img, oROI, filename,
                counter, figsize=(5, 5)):
...
if Test:
    ...
    if Scaling_test:
        ...
        for scale in ScalesDown:
            ...
            f = plot_resize(img, scale, nnscale, bscale, ed_img, ed_nnscale, ed_bscale, mr_img, wmr_img, mdr_img,
                            BigImages[0]["ROIs"][0], BigImages[0]["Filename"], counter=counter)
            counter += 1
    ...
    for file_dict in BigImages:
        ...
        for scale in ScalesDown:
            ...
            for ROI in file_dict['ROIs']:
                f = plot_resize(img, scale, nnscale, bscale, ed_img, ed_nnscale, ed_bscale, mr_img, wmr_img, mdr_img,
                                ROI, filename, counter=counter)  # set figszie
